...
class Title extends Component {
  ...
  update(title, description) {
    ...
    this.title.appendChild(document__default["default"].createTextNode(title));
    this.description.appendChild(document__default["default"].createTextNode(description));
  }
